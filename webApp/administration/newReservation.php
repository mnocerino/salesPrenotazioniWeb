...
<head>
    ...
    Pagina di creazione di una nuova prenotazione da parte di un amministratore.
    -->
            ...
            <form action="registerReservation.php" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="col-auto">
                        ...
                        <small id="userTip" class="form-text text-muted">Scegli a chi assegnare la prenotazione</small>
                    </div>
                </div>
